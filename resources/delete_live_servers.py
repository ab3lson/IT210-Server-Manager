...
def delete_multiple():
  ...
  confirm = input(f"Are you sure that you want to delete all servers between {color.BLUE + RANGE_START + color.RESET} and {color.BLUE + str(int(RANGE_END) - 1) + color.RESET}? (Y/N): ")
